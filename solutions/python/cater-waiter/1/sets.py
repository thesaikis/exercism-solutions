...
def categorize_dish(dish_name, dish_ingredients):
    ...
    if dish_ingredients & VEGAN == dish_ingredients:
        return dish_name + ": VEGAN"
    if dish_ingredients & VEGETARIAN == dish_ingredients:
        return dish_name + ": VEGETARIAN"
    if dish_ingredients & PALEO == dish_ingredients:
        return dish_name + ": PALEO"
    if dish_ingredients & KETO == dish_ingredients:
...
def compile_ingredients(dishes):
    ...
    return reduce(set.union, map(set, dishes))
